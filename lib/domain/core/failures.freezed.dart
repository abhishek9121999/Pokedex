...
class _$ValueFailureTearOff {
  ...
  _InvalidEmail<T> invalidEmail<T>({String? failedValue}) {
    return _InvalidEmail<T>(
      failedValue: failedValue,
    );
  }

  _ShortPassword<T> shortPassword<T>({String? failedValue}) {
...
abstract class _InvalidEmail<T> implements ValueFailure<T> {
  const factory _InvalidEmail({String? failedValue}) = _$_InvalidEmail<T>;
...
abstract class _ShortPassword<T> implements ValueFailure<T> {
  const factory _ShortPassword({String? failedValue}) = _$_ShortPassword<T>;
